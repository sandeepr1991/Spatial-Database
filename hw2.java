...
class hw2 {
    ...
    public static void query4(String[] args){
        ...
        switch(query_Number){
            ...
            case 1:
                query +="select t1.Stu_id from (select Distinct(Stu_Id) from HW2_Tram,HW2_Student where (ST_Distance(stu_location,Tram_location))<Tram_radius\n" +
"and (tram_id='t6ssl' )) as t1,\n" +
"(select Distinct(Stu_Id) from HW2_Tram,HW2_Student where (ST_Distance(stu_location,Tram_location))<Tram_radius\n" +
"and (tram_id='t2ohe' )) as t2 where t1.Stu_id=t2.Stu_Id\n" +
"UNION\n" +
"select t3.Bui_id from (select Distinct(Bui_Id) from HW2_Tram,HW2_Building where (ST_Distance(Bui_location,Tram_location))<Tram_radius\n" +
"and (tram_id='t6ssl' )) as t3,\n" +
"(select Distinct(Bui_Id) from HW2_Tram,HW2_Building where (ST_Distance(Bui_location,Tram_location))<Tram_radius\n" +
"and (tram_id='t2ohe' )) as t4 where t3.Bui_id=t4.Bui_id;";
                break;
            case 2:
            ...
            int left_x=999,left_y=999,right_x=0,right_y=0;
             ...
             while(rs.next()){
                ...
                if(preid.equals(id)|| preid.equals("first"))
                    ...
                    count=0;
                if(count<2 || preid.equals("first")){
                    if(preid.equals("first"))
                        count--;
